...
{
	[TestClass]
	public class Msvm_SystemExportSettingData
	{
        [TestMethod]
        public void Msvm_SystemExportSettingData_IsCurrent_Is_Equal_To_System_Management()
        {
            using (ManagementBaseObject msObject = WmiHelper.GetFirstSystemManagementObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            using (WmiObject wmiObject = WmiHelper.GetFirstWmiLightObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_IsCurrent_Is_UInt16()
        {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_IsDefault_Is_Equal_To_System_Management()
        {
            using (ManagementBaseObject msObject = WmiHelper.GetFirstSystemManagementObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            using (WmiObject wmiObject = WmiHelper.GetFirstWmiLightObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_IsDefault_Is_UInt16()
        {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_IsNext_Is_Equal_To_System_Management()
        {
            using (ManagementBaseObject msObject = WmiHelper.GetFirstSystemManagementObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            using (WmiObject wmiObject = WmiHelper.GetFirstWmiLightObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_IsNext_Is_UInt16()
        {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_ManagedElement_Is_Equal_To_System_Management()
        {
            using (ManagementBaseObject msObject = WmiHelper.GetFirstSystemManagementObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            using (WmiObject wmiObject = WmiHelper.GetFirstWmiLightObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_ManagedElement_Is_String()
        {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_SettingData_Is_Equal_To_System_Management()
        {
            using (ManagementBaseObject msObject = WmiHelper.GetFirstSystemManagementObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            using (WmiObject wmiObject = WmiHelper.GetFirstWmiLightObjects(@"root\virtualization\v2", "Msvm_SystemExportSettingData"))
            {
        ...
        [TestMethod]
        public void Msvm_SystemExportSettingData_SettingData_Is_String()
        {
